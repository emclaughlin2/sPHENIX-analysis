...
double Herwig_Jet12GeV_cross_section = 1.6873621636*6.7108e-7; // 6.7108e+05 pb
double Herwig_Jet20GeV_cross_section = 5.2613e-8; // 5.2613e+04 pb
double Herwig_Jet30GeV_cross_section = 2.0694e-9; // 2.0694e+03 pb
double Herwig_Jet40GeV_cross_section = 1.0510e-10; // 1.0510e+02 pb
double Herwig_Jet50GeV_cross_section = 5.2089e-12; // 5.2089 pb

double Herwig_Jet12GeV_scale = Herwig_Jet12GeV_cross_section/(double)(Herwig_Jet12GeV_cross_section);
double Herwig_Jet20GeV_scale = Herwig_Jet20GeV_cross_section/(double)(Herwig_Jet12GeV_cross_section);
double Herwig_Jet30GeV_scale = Herwig_Jet30GeV_cross_section/(double)(Herwig_Jet12GeV_cross_section);
double Herwig_Jet40GeV_scale = Herwig_Jet40GeV_cross_section/(double)(Herwig_Jet12GeV_cross_section);
double Herwig_Jet50GeV_scale = Herwig_Jet50GeV_cross_section/(double)(Herwig_Jet12GeV_cross_section);
