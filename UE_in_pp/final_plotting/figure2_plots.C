...
void figure2_plots(const char* filename = "topo_event_display_jet30_ex.root")
{
    ...
    Double_t alpha = 0.9;
    Int_t lightblue = TColor::GetColorTransparent(kGray+2, alpha);
    ...
    emcal_canvas->Update();
    emcal_canvas->SaveAs("emcal_topo_event_display_update.png");
    emcal_canvas->SaveAs("emcal_topo_event_display_update.pdf");
    ...
    ihcal_canvas->Update();
    ihcal_canvas->SaveAs("ihcal_topo_event_display_update.png");
    ihcal_canvas->SaveAs("ihcal_topo_event_display_update.pdf");
    ...
    ohcal_canvas->Update();
    ohcal_canvas->SaveAs("ohcal_topo_event_display_update.png");
    ohcal_canvas->SaveAs("ohcal_topo_event_display_update.pdf");
    ...
    legend->Draw("same");
    c1->Update();
    c1->SaveAs("topo_event_display_update.png");
    c1->SaveAs("topo_event_display_update.pdf");
