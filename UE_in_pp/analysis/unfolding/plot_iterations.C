...
void draw_iteration_graph(std::vector<TGraph*> graphs, std::vector<std::string> leg_tags, std::string syst_tag, std::string syst) {
    ...
    string outfile = "plots_run28/h_test_unfolding_iterations_all_respmatrices_pu_correct.png";
    if (syst != "") outfile = "plots_run28/h_test_unfolding_iterations_" + syst + "_pu_correct.png";
