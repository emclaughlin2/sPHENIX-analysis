...
void analysis_sim(std::string runtype = "mb", int start_seg = 0, int end_seg = 200, int iter = 1, std::string bkg_cut = "dijet", bool clusters = true, bool emcal_clusters = false)  {
    ...
    if (runtype == "mb") {
        ...
        truthjet_pt_min = 14;
        truthjet_pt_max = 22;
        if (iter > 1) count_filename = "analysis_sim_run21_output/output_"+bkg_cut+"_bkg_cut_sim_iter_1_jet10.root";
    } else if (runtype == "jet20") {
        weight_scale = Jet20GeV_scale;
        truthjet_pt_min = 22;
        truthjet_pt_max = 35;
        if (iter > 1) count_filename = "analysis_sim_run21_output/output_"+bkg_cut+"_bkg_cut_sim_iter_1_jet20.root";
    } else if (runtype == "jet30") {
        weight_scale = Jet30GeV_scale;
        truthjet_pt_min = 35;
        truthjet_pt_max = 52;
        if (iter > 1) count_filename = "analysis_sim_run21_output/output_"+bkg_cut+"_bkg_cut_sim_iter_1_jet30.root";
    } else if (runtype == "jet50") {
        weight_scale = Jet50GeV_scale;
        truthjet_pt_min = 52;
        truthjet_pt_max = 3000;
        if (iter > 1) count_filename = "analysis_sim_run21_output/output_"+bkg_cut+"_bkg_cut_sim_iter_1_jet50.root";
    ...
    string outfilename = "analysis_sim_run21_output/output_" + bkg_cut + "_bkg_cut_sim_iter_" + to_string(iter) + "_" + runtype + "_" + to_string(start_seg) + "_" + to_string(end_seg) + ".root";
