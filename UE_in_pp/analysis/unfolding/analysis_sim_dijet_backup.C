...
void analysis_sim_dijet(std::string runtype = "mb", int start_seg = 0, int end_seg = 200, bool clusters = true, bool emcal_clusters = false)  {
    ...
    if (runtype == "mb") {
        ...
        truthjet_pt_min = 14;
        truthjet_pt_max = 22;
        count_filename = "analysis_sim_output/output_dijet_jet10_4bin_newetbin_raw.root";
    } else if (runtype == "jet20") {
        weight_scale = Jet20GeV_scale;
        truthjet_pt_min = 22;
        truthjet_pt_max = 35;
        count_filename = "analysis_sim_output/output_dijet_jet20_4bin_newetbin_raw.root";
    } else if (runtype == "jet30") {
        weight_scale = Jet30GeV_scale;
        truthjet_pt_min = 35;
        truthjet_pt_max = 52;
        count_filename = "analysis_sim_output/output_dijet_jet30_4bin_newetbin_raw.root";
    } else if (runtype == "jet50") {
        weight_scale = Jet50GeV_scale;
        truthjet_pt_min = 52;
        truthjet_pt_max = 3000;
        count_filename = "analysis_sim_output/output_dijet_jet50_4bin_newetbin_raw.root";
    } else {
        std::cout << "Unknown runtype" << std::endl;
        return;
    }

    TFile *f_count = new TFile(count_filename.c_str(),"READ");
    RooUnfoldResponse* h_count = dynamic_cast<RooUnfoldResponse*>(f_count->Get("h_counts_calib_dijet"));
    const TMatrixD& counts_matrix = h_count->Mresponse(false);  
    TH2D* counts_measured = dynamic_cast<TH2D*>(h_count->Hmeasured());
    TH2D* counts_truth = dynamic_cast<TH2D*>(h_count->Htruth());
    f_count->Close();

    std::cout << "counts_measured: " << counts_measured->GetEntries() << " counts_truth: " << counts_truth->GetEntries() << std::endl;

    ////////// Files //////////
    TFile *f_out = new TFile(Form("analysis_sim_output/output_dijet_sim_%s_%d_%d.root", runtype.c_str(), start_seg, end_seg), "RECREATE");
    TChain chain("T");
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_trim_5",""); h_respmatrix_calib_dijet_trim_5->Setup(h_measure_calib_dijet, h_truth_calib_dijet);
    RooUnfoldResponse* h_respmatrix_calib_dijet_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_trim_10",""); h_respmatrix_calib_dijet_trim_10->Setup(h_measure_calib_dijet, h_truth_calib_dijet);
    RooUnfoldResponse* h_counts_calib_dijet = new RooUnfoldResponse("h_counts_calib_dijet",""); h_counts_calib_dijet->Setup(h_measure_calib_dijet, h_truth_calib_dijet);
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_jesdown_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jesdown_trim_5",""); h_respmatrix_calib_dijet_jesdown_trim_5->Setup(h_measure_calib_dijet_jesdown, h_truth_calib_dijet_jesdown);
    RooUnfoldResponse* h_respmatrix_calib_dijet_jesdown_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jesdown_trim_10",""); h_respmatrix_calib_dijet_jesdown_trim_10->Setup(h_measure_calib_dijet_jesdown, h_truth_calib_dijet_jesdown);
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_jesup_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jesup_trim_5",""); h_respmatrix_calib_dijet_jesup_trim_5->Setup(h_measure_calib_dijet_jesup, h_truth_calib_dijet_jesup);
    RooUnfoldResponse* h_respmatrix_calib_dijet_jesup_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jesup_trim_10",""); h_respmatrix_calib_dijet_jesup_trim_10->Setup(h_measure_calib_dijet_jesup, h_truth_calib_dijet_jesup);
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_jerdown_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jerdown_trim_5",""); h_respmatrix_calib_dijet_jerdown_trim_5->Setup(h_measure_calib_dijet_jerdown, h_truth_calib_dijet_jerdown);
    RooUnfoldResponse* h_respmatrix_calib_dijet_jerdown_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jerdown_trim_10",""); h_respmatrix_calib_dijet_jerdown_trim_10->Setup(h_measure_calib_dijet_jerdown, h_truth_calib_dijet_jerdown);
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_jerup_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jerup_trim_5",""); h_respmatrix_calib_dijet_jerup_trim_5->Setup(h_measure_calib_dijet_jerup, h_truth_calib_dijet_jerup);
    RooUnfoldResponse* h_respmatrix_calib_dijet_jerup_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_jerup_trim_10",""); h_respmatrix_calib_dijet_jerup_trim_10->Setup(h_measure_calib_dijet_jerup, h_truth_calib_dijet_jerup);
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_half1 = new RooUnfoldResponse("h_respmatrix_calib_dijet_half1",""); h_respmatrix_calib_dijet_half1->Setup(h_measure_calib_dijet_half1, h_truth_calib_dijet_half1);
    RooUnfoldResponse* h_respmatrix_calib_dijet_half1_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_half1_trim_5",""); h_respmatrix_calib_dijet_half1_trim_5->Setup(h_measure_calib_dijet_half1, h_truth_calib_dijet_half1);
    RooUnfoldResponse* h_respmatrix_calib_dijet_half1_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_half1_trim_10",""); h_respmatrix_calib_dijet_half1_trim_10->Setup(h_measure_calib_dijet_half1, h_truth_calib_dijet_half1);
    ...
    RooUnfoldResponse* h_respmatrix_calib_dijet_half2 = new RooUnfoldResponse("h_respmatrix_calib_dijet_half2",""); h_respmatrix_calib_dijet_half2->Setup(h_measure_calib_dijet_half2, h_truth_calib_dijet_half2);
    RooUnfoldResponse* h_respmatrix_calib_dijet_half2_trim_5 = new RooUnfoldResponse("h_respmatrix_calib_dijet_half2_trim_5",""); h_respmatrix_calib_dijet_half2_trim_5->Setup(h_measure_calib_dijet_half2, h_truth_calib_dijet_half2);
    RooUnfoldResponse* h_respmatrix_calib_dijet_half2_trim_10 = new RooUnfoldResponse("h_respmatrix_calib_dijet_half2_trim_10",""); h_respmatrix_calib_dijet_half2_trim_10->Setup(h_measure_calib_dijet_half2, h_truth_calib_dijet_half2);
    ...
    //for (Long64_t entry = 0; entry < 20; ++entry) {
        ...
        fill_trim_response_matrix(h_respmatrix_calib_dijet_trim_5, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jesdown_trim_5, calibjet_pt_dijet_jesdown, calibjet_matched_dijet_jesdown, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jesup_trim_5, calibjet_pt_dijet_jesup, calibjet_matched_dijet_jesup, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jerdown_trim_5, calibjet_pt_dijet_jerdown, calibjet_matched_dijet_jerdown, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jerup_trim_5, calibjet_pt_dijet_jerup, calibjet_matched_dijet_jerup, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);

        fill_trim_response_matrix(h_respmatrix_calib_dijet_trim_10, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jesdown_trim_10, calibjet_pt_dijet_jesdown, calibjet_matched_dijet_jesdown, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jesup_trim_10, calibjet_pt_dijet_jesup, calibjet_matched_dijet_jesup, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jerdown_trim_10, calibjet_pt_dijet_jerdown, calibjet_matched_dijet_jerdown, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
        fill_trim_response_matrix(h_respmatrix_calib_dijet_jerup_trim_10, calibjet_pt_dijet_jerup, calibjet_matched_dijet_jerup, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
       
        if (entry % 2 == 0){
            fill_response_matrix(h_truth_calib_dijet_half1, h_measure_calib_dijet_half1, h_respmatrix_calib_dijet_half1, h_fake_calib_dijet_half1, h_miss_calib_dijet_half1, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale);
            fill_trim_response_matrix(h_respmatrix_calib_dijet_half1_trim_5, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);
            fill_trim_response_matrix(h_respmatrix_calib_dijet_half1_trim_10, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
        } else {
            fill_response_matrix(h_truth_calib_dijet_half2, h_measure_calib_dijet_half2, h_respmatrix_calib_dijet_half2, h_fake_calib_dijet_half2, h_miss_calib_dijet_half2, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale);
            fill_trim_response_matrix(h_respmatrix_calib_dijet_half2_trim_5, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 5);
            fill_trim_response_matrix(h_respmatrix_calib_dijet_half2_trim_10, calibjet_pt_dijet, calibjet_matched_dijet, goodtruthjet_pt, et_transverse, truth_et_transverse, weight_scale, counts_matrix, counts_measured, counts_truth, 10);
        }
    }
    ...
    h_truth_calib_dijet->Write(); h_measure_calib_dijet->Write(); h_respmatrix_calib_dijet->Write(); h_respmatrix_calib_dijet_trim_5->Write(); h_respmatrix_calib_dijet_trim_10->Write(); h_fake_calib_dijet->Write(); h_miss_calib_dijet->Write(); 
    h_counts_calib_dijet->Write(); h_counts_fake_calib_dijet->Write(); h_counts_miss_calib_dijet->Write(); h_jet_pt_respmatrix_calib_dijet->Write(); h_calo_et_respmatrix_calib_dijet->Write(); h_nw_jet_pt_respmatrix_calib_dijet->Write(); h_nw_calo_et_respmatrix_calib_dijet->Write();
    h_truth_calib_dijet_jesdown->Write(); h_measure_calib_dijet_jesdown->Write(); h_respmatrix_calib_dijet_jesdown->Write(); h_respmatrix_calib_dijet_jesdown_trim_5->Write(); h_respmatrix_calib_dijet_jesdown_trim_10->Write(); h_fake_calib_dijet_jesdown->Write(); h_miss_calib_dijet_jesdown->Write();
    h_truth_calib_dijet_jesup->Write(); h_measure_calib_dijet_jesup->Write(); h_respmatrix_calib_dijet_jesup->Write(); h_respmatrix_calib_dijet_jesup_trim_5->Write(); h_respmatrix_calib_dijet_jesup_trim_10->Write(); h_fake_calib_dijet_jesup->Write(); h_miss_calib_dijet_jesup->Write();
    h_truth_calib_dijet_jerdown->Write(); h_measure_calib_dijet_jerdown->Write(); h_respmatrix_calib_dijet_jerdown->Write(); h_respmatrix_calib_dijet_jerdown_trim_5->Write(); h_respmatrix_calib_dijet_jerdown_trim_10->Write(); h_fake_calib_dijet_jerdown->Write(); h_miss_calib_dijet_jerdown->Write();
    h_truth_calib_dijet_jerup->Write(); h_measure_calib_dijet_jerup->Write(); h_respmatrix_calib_dijet_jerup->Write(); h_respmatrix_calib_dijet_jerup_trim_5->Write(); h_respmatrix_calib_dijet_jerup_trim_10->Write(); h_fake_calib_dijet_jerup->Write(); h_miss_calib_dijet_jerup->Write();
    h_truth_calib_dijet_half1->Write(); h_measure_calib_dijet_half1->Write(); h_respmatrix_calib_dijet_half1->Write(); h_respmatrix_calib_dijet_half1_trim_5->Write(); h_respmatrix_calib_dijet_half1_trim_10->Write(); h_fake_calib_dijet_half1->Write(); h_miss_calib_dijet_half1->Write();
    h_truth_calib_dijet_half2->Write(); h_measure_calib_dijet_half2->Write(); h_respmatrix_calib_dijet_half2->Write(); h_respmatrix_calib_dijet_half2_trim_5->Write(); h_respmatrix_calib_dijet_half2_trim_10->Write(); h_fake_calib_dijet_half2->Write(); h_miss_calib_dijet_half2->Write();
