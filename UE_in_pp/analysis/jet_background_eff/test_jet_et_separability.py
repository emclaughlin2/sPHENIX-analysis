...
cut_name = ["efrac","none"]
legend_entries = ['Energy frac bkg cut','Energy frac bkg cut','No bkg cut','No bkg cut']
...
line.Draw("SAME")
canvas.SaveAs(f"jet_bkgeff_binned_comparison.png")
...
line.SetLineColor(ROOT.kGray + 2)
line.Draw("SAME")
canvas.SaveAs(f"etdist_bkgeff_binned_comparison.png")
