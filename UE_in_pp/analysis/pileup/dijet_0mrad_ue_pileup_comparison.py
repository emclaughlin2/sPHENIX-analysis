...
x_vals = array('f', [1.0, 2.5, 3.5, 4.5, 5.5, 6.5, 8.5])
n_points = len(x_vals)
...
# Add legend
legend = ROOT.TLegend(0.55, 0.82, 0.88, 0.92)
legend.AddEntry(g_tm, "Towards Region", "lp")
#legend.AddEntry(g_trm, "Transverse Region", "lp")
#legend.AddEntry(g_am, "Away", "lp")
legend.Draw()

c.Update()
c.Draw()
c.SaveAs("0mrad_plots/h_ue_pileup_towards_15_20GeV_Topoclusters.png")
...
g_tm.GetYaxis().SetRangeUser(0.27,0.3)
...
# Add legend
legend = ROOT.TLegend(0.55, 0.82, 0.88, 0.92)
#legend.AddEntry(g_tm, "Towards", "lp")
legend.AddEntry(g_trm, "Transverse Region", "lp")
#legend.AddEntry(g_am, "Away", "lp")
legend.Draw()
...
c.Update()
c.Draw()
c.SaveAs("0mrad_plots/h_ue_pileup_transverse_15_20GeV_Topoclusters.png")
...
g_tm.GetYaxis().SetRangeUser(2.94,3)
...
#legend.AddEntry(g_tm, "Towards Region", "lp")
#legend.AddEntry(g_trm, "Transverse Region", "lp")
legend.AddEntry(g_am, "Away Region", "lp")
legend.Draw()

c.Update()
c.Draw()
c.SaveAs("0mrad_plots/h_ue_pileup_away_15_20GeV_Topoclusters.png")

canvas = ROOT.TCanvas("canvas","",600,500)
leg = ROOT.TLegend(.55,.65,.92,.92)
leg.AddEntry("","#bf{Towards Region}","")
leg.AddEntry("","15 < p_{T,lead} < 20 GeV","")
for i in range(len(h_ue_towards)):
    leg.AddEntry(h_ue_towards[i],leg_tags[i],"pl")
    h_ue_towards[i].SetStats(0)
    h_ue_towards[i].SetLineColor(colors[i])
    h_ue_towards[i].SetMarkerColor(colors[i])
    h_ue_towards[i].GetXaxis().SetRangeUser(-2,20)
    h_ue_towards[i].SetXTitle("#SigmaE_{T}/#delta#eta#delta#phi [GeV]") 
    if i == 0:
        h_ue_towards[i].Draw()
    else:
        h_ue_towards[i].Draw('same')
canvas.SetLogy(1)
leg.SetTextSize(0.035)
leg.Draw()
canvas.Draw()
canvas.SaveAs("0mrad_plots/h_ue_towards_15_20GeV_Topoclusters.png")

canvas = ROOT.TCanvas("canvas","",600,500)
leg = ROOT.TLegend(.55,.65,.92,.92)
leg.AddEntry("","#bf{Transverse Region}","")
leg.AddEntry("","15 < p_{T,lead} < 20 GeV","")
for i in range(len(h_ue_transverse)):
    leg.AddEntry(h_ue_transverse[i],leg_tags[i],"pl")
    h_ue_transverse[i].SetStats(0)
    h_ue_transverse[i].SetLineColor(colors[i])
    h_ue_transverse[i].SetMarkerColor(colors[i])
    h_ue_transverse[i].GetXaxis().SetRangeUser(-3,13)
    h_ue_transverse[i].SetXTitle("#SigmaE_{T}/#delta#eta#delta#phi [GeV]") 
    if i == 0:
        h_ue_transverse[i].Draw()
    else:
        h_ue_transverse[i].Draw('same')
canvas.SetLogy(1)
leg.SetTextSize(0.035)
leg.Draw()
canvas.Draw()
canvas.SaveAs("0mrad_plots/h_ue_transverse_15_20GeV_Topoclusters.png")

canvas = ROOT.TCanvas("canvas","",600,500)
leg = ROOT.TLegend(.55,.65,.92,.92)
leg.AddEntry("","#bf{Away Region}","")
leg.AddEntry("","15 < p_{T,lead} < 20 GeV","")
for i in range(len(h_ue_away)):
    leg.AddEntry(h_ue_away[i],leg_tags[i],"pl")
    h_ue_away[i].SetStats(0)
    h_ue_away[i].SetLineColor(colors[i])
    h_ue_away[i].SetMarkerColor(colors[i])
    h_ue_away[i].GetXaxis().SetRangeUser(-1,20)
    h_ue_away[i].SetXTitle("#SigmaE_{T}/#delta#eta#delta#phi [GeV]") 
    if i == 0:
        h_ue_away[i].Draw()
    else:
        h_ue_away[i].Draw('same')
canvas.SetLogy(1)
leg.SetTextSize(0.035)
leg.Draw()
canvas.Draw()
canvas.SaveAs("0mrad_plots/h_ue_away_15_20GeV_Topoclusters.png")
